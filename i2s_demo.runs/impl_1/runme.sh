...
HD_PWD='C:/Users/danny/OneDrive/Desktop/FPGA/i2s_demo/i2s_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_demo_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2s_demo_top_level.tcl -notrace
