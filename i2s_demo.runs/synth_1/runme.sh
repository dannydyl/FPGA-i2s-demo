...
HD_PWD='C:/Users/danny/OneDrive/Desktop/FPGA/i2s_demo/i2s_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_demo_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_demo_top_level.tcl
